...
2.  Once your microSD card connected to your computer, select it under "Choose Storage".
4.  Click "Write".
4.  Once writing is complete complete, remove the microSD card, and place it into the Raspberry Pi.
5.  If not already done so, attach your Pioreactor HAT to your Raspberry Pi. Ensure the two pieces fit snugly together.
