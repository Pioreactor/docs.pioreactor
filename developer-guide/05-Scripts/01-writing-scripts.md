...
You can also use the [Pioreactor's plugin architecture](https://docs.pioreactor.com/developer-guide/plugins#custom-scripts) to control the start and stop of the script.
