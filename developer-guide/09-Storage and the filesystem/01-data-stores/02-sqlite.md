...
Using the sqlite shell (`pio db`), you can execute any SQL statements, including creating new tables. Plugins can also automatically create new tables when installed, [see instructions here](/developer-guide/plugins/python-package#5-optional-adding-leader-database-tables-and-exposing-them-on-the-export-data-page).
