...
Starting in version 23.9.19, we introduced a new way to create and edit experiment profiles. Experiment profiles can now be managed in the UI at `/experiment-profiles`. See video below for a demonstration.
