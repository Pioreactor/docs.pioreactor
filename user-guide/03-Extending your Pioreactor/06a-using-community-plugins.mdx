...
Pioreactor has added a platform so that community members can make their own extensions and share them with others. We call these _plugins._ (Below is how to install plugins - if you are looking to create your own plugins, see [here](/developer-guide/plugins/python-package).)
