...
![Inventory card with the Model dropdown and options highlighted.](/img/user-guide/03-extending-your-pioreactor/01-cluster-management/03-change-model/inventory-model-dropdown.png)
