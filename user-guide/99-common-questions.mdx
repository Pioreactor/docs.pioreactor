...
#### When I click an action in the UI, I don't see any response
 ...
 - If you _also_ had trouble accessing the UI (see question above), in your configuration, change the `leader_address` field to whatever worked above, an IP for example.
