...
³ Note that you don't need a lot of RAM for the Pioreactor, so we recommend getting the lower RAM option RPi (1GB or 2GB) to save some money. However, anything above is fine, too.
