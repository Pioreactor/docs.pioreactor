...
slug: /20ml-v15-wetware-assembly
...
3.  **While maintaining pressure**, flip the holder and insert the two <Highlight color={colors.green}>M2.5-CS 6mm screws</Highlight> (heads up: your screws might be brass, not black) into the holes - **don't tighten fully yet**.
