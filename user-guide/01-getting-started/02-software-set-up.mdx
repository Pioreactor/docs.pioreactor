...
17. Click **Write** to begin writing your image to the micro SD card.
    ...
    :::tip
    If Raspberry Pi Imager fails while writing, first try **Erase** in Raspberry Pi Imager to format the card as FAT32, then write the image again. If writing still fails, try a different, reputable microSD card.
    :::
