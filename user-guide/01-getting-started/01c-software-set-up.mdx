...
2.  A blank microSD card, at least 16GB. We like SanDisk and Samsung SD cards for their longevity.
...
2. After a few minutes, connect the new Pioreactor worker to your cluster using the UI. See next steps.
