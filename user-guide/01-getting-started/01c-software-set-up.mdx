...
2.  A blank microSD card, at least 16GB. We like 16GB or 32GB SanDisk and Samsung SD cards for their longevity, but any good quality, class 10 SD card will do.
...
1. Follow the same instructions above, but use a [Pioreactor Worker image](https://github.com/pioreactor/custopizer/releases/latest/download/pioreactor_worker.zip) instead. All the settings are the same, **except for the hostname**. See note below:
...
#### My Pioreactor never flashes the blue LED
