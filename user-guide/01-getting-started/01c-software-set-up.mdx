...
8.  Plug in the power cord into your Raspberry Pi. LEDs onboard the Raspberry Pi should start to light up. After about **three minutes**, your Pioreactor HAT will briefly blink a blue LED, signifying it is ready.
