...
2. After the image is written to the microSD card, place the microSD card into the Raspberry Pi and power it on.

3. The Pioreactor's blue LED will light up and stay on, indicating that it's ready to be connected. Move onto the next step.
