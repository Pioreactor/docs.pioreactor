...
2. Download the [Raspberry Pi Imager](https://www.raspberrypi.org/software/) for your operating system, install it, and
...
10. The Pioreactor is now ready for use! Follow [this guide](/user-guide/prepare-vial-for-cultures) to setting up your first experiment.
