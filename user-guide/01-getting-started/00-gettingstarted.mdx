...
<div className="cardGrid">
    <Card imageUrl="user-guide/03-extending-your-pioreactor/13-precision-temperature-upgrade-kit/installed-pioreactor.jpg" headerText="Precision Temperature Upgrade Kit" linkUrl="/user-guide/precision-temperature-upgrade-kit" />
    <Card imageUrl="user-guide/hardware-assembly/upgrade_XR/40ml-xr.png" headerText="Pioreactor 40ml v1.5 → XR upgrade kit" linkUrl="/user-guide/40ml-v15-to-XR-upgrade-disassembly" />
    <Card imageUrl="user-guide/hardware-assembly/upgrade_XR/20ml-xr.png" headerText="Pioreactor 20ml v1.5 → XR upgrade kit" linkUrl="/user-guide/20ml-v15-to-XR-upgrade-disassembly" />
