...
<div className="cardGrid">
    <Card imageUrl="user-guide/03-extending-your-pioreactor/13-precision-temperature-upgrade-kit/sensor-orientation.jpg" headerText="Precision Temperature Upgrade Kit" linkUrl="/user-guide/precision-temperature-upgrade-kit" />
